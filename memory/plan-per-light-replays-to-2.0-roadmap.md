...
УТОЧНЕНИЕ09-17: после закрытия шага2 пользователь поставил перед релизом упрощение UX Lit/Outline в BBS-аддоне. Сначала1.20.4, затем порт нового UX после ручной приёмки. Порядок треков/групп сохранить. Реализовано в _wt-addon-1.20.x, автоматические проверки PASS, runtime OPEN; [[project-replay-selection-ux]]. Отдельный шаг3 (irlights editor) этим не закрыт.
