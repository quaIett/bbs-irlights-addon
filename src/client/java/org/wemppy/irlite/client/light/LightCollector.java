...
public final class LightCollector
{
    ...
    private static void emitPoint(PointLightForm form, Matrix4f matrix)
    {
        ...
        LightRegistry.registerPoint(origin.x, origin.y, origin.z, c.r, c.g, c.b, form.intensity.get(), form.radius.get(), form.entitiesOnly.get(), form.anisotropy.get(), form.vlDensity.get(), form.beamStrength.get(), form.bulbSize.get(), form.shadows.get(), System.identityHashCode(form));
    }
    ...
    private static void emitSpot(SpotlightForm form, Matrix4f matrix)
    {
        ...
        Color c = form.color.get();
        LightRegistry.registerSpot(origin.x, origin.y, origin.z, dx, dy, dz, c.r, c.g, c.b, form.intensity.get(), form.range.get(), cosOuter, cosInner, form.entitiesOnly.get(), form.anisotropy.get(), form.vlDensity.get(), form.beamStrength.get(), form.bulbSize.get(), form.shadows.get(), System.identityHashCode(form));
    }
}
