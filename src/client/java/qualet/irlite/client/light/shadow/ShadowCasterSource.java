 ...
 * vanilla {@code EntityRenderDispatcher} render (redactor-main); an inflated box
 * blob into a raw depth VBO (redactor-port 1.21.11); BBS Form/Film/Morph
 * silhouettes (IRLite, see {@link IRLiteBbsCasterSource}).
 */
