...
public class SpotlightFormRendererBaseline extends AbstractLightFormRenderer<SpotlightForm>
{
    public SpotlightFormRendererBaseline(SpotlightForm form)
    {
        super(form);
    }
    ...
    {
        Vector3d p = IRLightPositionResolverBaseline.resolve(context);
        ...
        int cookieLayer = CookieArrayBaseline.resolve(this.form.cookie.get());
